...
if(estimator=="tmle-lstm"){
  learner_stack_A <- make_learner_stack(list("Lrnr_lstm_keras",batch_size=32, units=32, dropout=0.5, recurrent_dropout=0.5, activation='tanh', recurrent_activation='sigmoid', recurrent_out='softmax', epochs=100,  layers=2, callbacks = list(keras::callback_early_stopping(patience = 3, restore_best_weights=TRUE)), validation_split=0.2),
                                        list("Lrnr_lstm_keras",batch_size=32, units=32, dropout=0.5, recurrent_dropout=0.5, activation='tanh', recurrent_activation='sigmoid', recurrent_out='softmax', epochs=100,  layers=1, callbacks = list(keras::callback_early_stopping(patience = 3, restore_best_weights=TRUE)), validation_split=0.2)) #loss="categorical_crossentropy"
  learner_stack_A_bin <- make_learner_stack(list("Lrnr_lstm_keras",batch_size=32, units=32, dropout=0.5, recurrent_dropout=0.5, activation='tanh', recurrent_activation='sigmoid', recurrent_out='sigmoid', epochs=100,  layers=2, callbacks = list(keras::callback_early_stopping(patience = 3, restore_best_weights=TRUE)), validation_split=0.2),
                                            list("Lrnr_lstm_keras",batch_size=32, units=32, dropout=0.5, recurrent_dropout=0.5, activation='tanh', recurrent_activation='sigmoid', recurrent_out='sigmoid', epochs=100,  layers=1, callbacks = list(keras::callback_early_stopping(patience = 3, restore_best_weights=TRUE)), validation_split=0.2)) # loss="binary_crossentropy
  ...
  learner_stack_Y_cont <-  make_learner_stack(list("Lrnr_lstm_keras",batch_size=32, units=32, dropout=0.5, recurrent_dropout=0.5, activation='tanh', recurrent_activation='sigmoid', recurrent_out='linear', epochs=100,  layers=2, callbacks = list(keras::callback_early_stopping(patience = 3, restore_best_weights=TRUE)), validation_split=0.2),
                                              list("Lrnr_lstm_keras",batch_size=32, units=32, dropout=0.5, recurrent_dropout=0.5, activation='tanh', recurrent_activation='sigmoid', recurrent_out='linear', epochs=100,  layers=1, callbacks = list(keras::callback_early_stopping(patience = 3, restore_best_weights=TRUE)), validation_split=0.2)) # loss="mse"
}
