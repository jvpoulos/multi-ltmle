...
# Script specifically for running the tmle-lstm estimator with all fixes
# This estimator had issues with invalid slice indices and weights_bin not found

# Parameters
estimator="tmle-lstm"  # Use LSTM tmle estimator
cores="1"              # Use single core
use_sl="TRUE"          # Use SuperLearner
do_mpi="FALSE"         # Don't use MPI

echo "Running TMLE-LSTM simulation with all fixes applied..."
